...
/*   Updated: 2016/09/22 16:42:20 by fhuang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					init_env(t_printf *e);
void					destroy_env(t_printf *e);

/*
**	LIST
*/

void					add_link(t_printf *e, t_print *new, t_bool arg);
int						new_link(t_printf *e, char *str,\
							char *type, t_bool arg);

/*
**	PARSE FORMAT
*/

char					*get_color(t_printf *e, char *str);
...
int						read_str(t_printf *e, char *str);
...
void					read_and_transform_arg(t_printf *e);
